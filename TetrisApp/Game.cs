...
namespace TetrisApp
{
    ...
    public class Game
    {
        ...
        public void MoveBoardFields_DOWN(int KilledLine_y)
        {
            for (int new_Y = KilledLine_y - 1; new_Y > 0; new_Y--)
            {
                ...
                for (int x = 0; x < this.Config.Width_GameBoard; x++)
                {
                    ...
                    {
                        MoveOneBoardField_Down(this.Board.Array_Board[x, new_Y]);               // ==> Dann bewege DIESES Field nach unten
                    }
                }
            }
        }
        ...
        // MoveDown-Event, bewegt den aktiven Block in festgelegten Intervallen nach unten
        ...
        /// <summary>
        /// Startet das Spiel, spawnt einen stein, startet Timer etc...
        /// </summary>
        ...
        // Berechnet die UHRzeit
        public DateTime GetRealTime()
        {
            return (DateTime.Now).Add(TimeSpan.FromHours(1));
        }

        // Wenn Spiel beendet, halte es an und zeige Highscores an und speichere diese in Datei
        public void GameOver()
        {
            ...
            if (File.Exists("C:\\Users\\Public\\HighScore_JSON.txt"))
            {
                this.LoadGame();
            }
        ...
        // Pausiert das Spiel bz wlässt es wieder weiter laufen
        public void Pause()
        {
        ...
        // Bisher nur für HighScores
        public void SaveGame()
        {
            this.Config.SetHighScore();
            this.Config.CONVERT__HighScore_Core__TO__HighScore_Export();
            this.Json.ExportData(this.Config.HighScore_Export, "HighScore_JSON");
        }

        // Bisher nur für HighScores inkl name
